...
# Hole.create({course_id: 1, gender: "m", hole_number: 1, par: 5, handicap_rating: 9, gender: "m"})
# Hole.create({course_id: 1, gender: "m", hole_number: 2, par: 4, handicap_rating: 1, gender: "m"})
# Hole.create({course_id: 1, gender: "m", hole_number: 3, par: 5, handicap_rating: 13, gender: "m"})
# Hole.create({course_id: 1, gender: "m", hole_number: 4, par: 4, handicap_rating: 7, gender: "m"})
# Hole.create({course_id: 1, gender: "m", hole_number: 5, par: 4, handicap_rating: 5, gender: "m"})
# Hole.create({course_id: 1, gender: "m", hole_number: 6, par: 3, handicap_rating: 17, gender: "m"})
# Hole.create({course_id: 1, gender: "m", hole_number: 7, par: 4, handicap_rating: 3, gender: "m"})
# Hole.create({course_id: 1, gender: "m", hole_number: 8, par: 3, handicap_rating: 15, gender: "m"})
# Hole.create({course_id: 1, gender: "m", hole_number: 9, par: 4, handicap_rating: 11, gender: "m"})
# Hole.create({course_id: 1, gender: "m", hole_number: 10, par: 4, handicap_rating: 2, gender: "m"})
# Hole.create({course_id: 1, gender: "m", hole_number: 11, par: 3, handicap_rating: 8, gender: "m"})
# Hole.create({course_id: 1, gender: "m", hole_number: 12, par: 4, handicap_rating: 14, gender: "m"})
# Hole.create({course_id: 1, gender: "m", hole_number: 13, par: 5, handicap_rating: 10, gender: "m"})
# Hole.create({course_id: 1, gender: "m", hole_number: 14, par: 3, handicap_rating: 18, gender: "m"})
# Hole.create({course_id: 1, gender: "m", hole_number: 15, par: 4, handicap_rating: 16, gender: "m"})
# Hole.create({course_id: 1, gender: "m", hole_number: 16, par: 4, handicap_rating: 6, gender: "m"})
# Hole.create({course_id: 1, gender: "m", hole_number: 17, par: 4, handicap_rating: 4, gender: "m"})
# Hole.create({course_id: 1, gender: "m", hole_number: 18, par: 4, handicap_rating: 12, gender: "m"})
